...
* **Total Countries** — Number of countries covered
* **Average Rating** — Average customer rating across restaurants
* **Total Votes** — Total customer votes received
* **Total Cuisines** — Number of unique cuisines available


### 🔹 Business Analysis KPIs

* **Cuisine Wise Restaurant Count** — Most popular cuisines
* **Average Rating by Cuisine** — Best performing cuisines
...
* Cuisine Analysis (Bar + Line Chart)
* Online Delivery Pie Chart
* Table Booking Donut Chart
